...
module.exports = {
    ...
    readConfig: async function readConfig() {
        try {
    ...
    readTemplate: async function readTemplate(folder, file) {
        try {
    ...
    writeOutputFile: async function writeOutputFile(content, folder, filepath) {
        try {
